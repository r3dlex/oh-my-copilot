...
oh-my-githubcopilot is a multi-agent orchestration plugin for GitHub Copilot CLI with 23 agents, 25 skills, and a growing plugin architecture. Architectural decisions have previously been tracked in `spec/*.md` files and `.omp/plans/` documents without automated enforcement.
